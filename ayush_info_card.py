...
ROWS = [
    ("host",),
    ("kv", "Now", "Data science and AI masters Student @ GISMA berlin"),
    ("kv", "Edu", "B.Tech AI & ML @ PTU'25 "),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "HTML,CSS"),
    ("kv", "Databases", "Python,mySQL,tableau,Excel"),
